...
| <a name="input_custom_iam_policy_arn"></a> [custom\_iam\_policy\_arn](#input\_custom\_iam\_policy\_arn) | List of custom policy to be attached to the lambda role | `set(string)` | `[]` | no |
